    ...
    <div
        ...
        @if (Route::has('login'))
            <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                <ul>
                    <li><a href="/" class="text-sm text-gray-700 dark:text-gray-500 underline">En</a></li>
                    <li><a href="/ru/" class="text-sm text-gray-700 dark:text-gray-500 underline">Ru</a></li>
                </ul>
                @auth
